...
declare namespace CodeMirror {
    var Doc: CodeMirror.DocConstructor;
    var Pos: CodeMirror.PositionConstructor;
    var StringStream: CodeMirror.StringStreamConstructor;
    var Pass: {
    ...
    function innerMode(mode: Mode<any>, state: any): {
        state: any;
        mode: Mode<any>;
    };
    ...
    interface Editor extends Doc {
        ...
        cursorCoords(where?: boolean, mode?: CoordsMode): {
            left: number;
            top: number;
            bottom: number;
        };
        ...
        cursorCoords(where?: CodeMirror.Position | null, mode?: CoordsMode): {
            left: number;
            top: number;
            bottom: number;
        };
        ...
        charCoords(pos: CodeMirror.Position, mode?: CoordsMode): {
            left: number;
            right: number;
            top: number;
            bottom: number;
        ...
        coordsChar(object: {
            left: number;
            top: number;
        }, mode?: CoordsMode): CodeMirror.Position;
    ...
    interface Doc {
        ...
        setSelection(anchor: CodeMirror.Position, head?: CodeMirror.Position, options?: {
            bias?: number;
            origin?: string;
            scroll?: boolean;
        }): void;
    ...
    interface AsyncLinter {
        (content: string, updateLintingCallback: UpdateLintingCallback, options: LintStateOptions | any, codeMirror: Editor): void;
    }
    /**
...
//# sourceMappingURL=helpcenter.codemirror.d.ts.map