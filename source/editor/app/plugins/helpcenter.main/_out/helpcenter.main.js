...
(function (helpcenter) {
    ...
    (function (main_1) {
        ...
        async function initVersion() {
            ...
            document.title = `Unofficial Phaser Help Center v${colibri.PRODUCT_VERSION} - Phaser v${helpcenter.phaser.PHASER_VER} - Phaser Editor 2D`;
            console.log("Phaser Editor 2D - Unofficial Phaser Help - v" + colibri.PRODUCT_VERSION);
        }
        ...
        (function (core) {
            ...
            class HtmlJSDocBuilder {
                ...
                renderMemberIcon(child, rowContent) {
                    const iconName = main.DOC_ENTRY_KIND_ICON_NAME[child.getKind()];
