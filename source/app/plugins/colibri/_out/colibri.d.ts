declare namespace colibri {
    abstract class Plugin {
        ...
        getThemeIcon(name: string, theme: "dark" | "light" | "common"): ui.controls.IImage;
...
declare namespace colibri.ui.ide {
    class Workbench {
        ...
        private hideSplash;
        private resetCache;
        openProject(projectName: string, workspacePath: string, monitor: controls.IProgressMonitor): Promise<void>;
...
declare namespace colibri.ui.controls {
    class ToolbarManager {
        ...
        addCommand(commandId: string, config?: IActionConfig): void;
        addAction(config: IActionConfig): void;
        add(action: Action): void;
        dispose(): void;
...
declare namespace colibri.ui.controls.properties {
    ...
    abstract class PropertySection<T> {
        ...
        abstract createForm(parent: HTMLDivElement): any;
        ...
        createMenuButton(parent: HTMLElement, text: string, items: Array<{
            name: string;
            value: any;
        ...
        createMenuIcon(parent: HTMLElement, menuProvider: () => Menu, alignRight?: boolean): IconControl;
    }
}
declare namespace colibri.ui.controls.properties {
...
declare namespace colibri.ui.controls.viewers {
    class TreeViewerRenderer {
        ...
        protected renderStyledLabel(args: RenderCellArgs, x: number, y: number, styledProvider: IStyledLabelProvider): void;
...
declare namespace colibri.ui.controls.viewers {
    abstract class Viewer extends Control {
        ...
        protected prepareFiltering(): void;
...
declare namespace colibri.ui.ide {
    ...
    class FileUtils {
        ...
        static getProjects_async(workspacePath?: string): Promise<io.IProjectsData>;
