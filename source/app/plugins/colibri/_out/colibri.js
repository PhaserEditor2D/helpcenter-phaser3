                    ...
                    if (!IconControl._themeListenerRegistered) {
                        ...
                        colibri.Platform.getWorkbench().eventThemeChanged.addListener(() => {
                            ...
                            for (let i = 0; i < result.length; i++) {
                                ...
                                const control = elem["__IconControl"];
                                control.repaint();
                            }
                        });
                    }
                    ...
                    paintItems(objects, treeIconList, paintItems, parentPaintItem, x, y) {
                        ...
                        for (const obj of objects) {
                            ...
                            if (viewer.isFilterIncluded(obj)) {
                                ...
                                const item = new viewers.PaintItem(paintItems.length, obj, parentPaintItem, isItemVisible);
                            ...
                            if (viewer.isFilterIncluded(obj)) {
                                ...
                                if (y > -cellSize && y < b.height) {
                                    ...
                                    if (children.length > 0 && !this._flat) {
                                        ...
                                        context.save();
                                        const iconX = x + 5;
                                        icon.paint(context, iconX, iconY, controls.RENDER_ICON_SIZE, controls.RENDER_ICON_SIZE, false);
                                        context.restore();
                                        treeIconList.push({
                                            rect: new controls.Rect(iconX, iconY, controls.RENDER_ICON_SIZE, controls.RENDER_ICON_SIZE),
                                            obj: obj
                                        });
                                    }
                                    isItemVisible = true;
        ...
        (function (ide) {
            class ViewerView extends ide.ViewPart {
                ...
                createPart() {
                    ...
                    this._filteredViewer = new ui.controls.viewers.FilteredViewer(this._viewer, true);
